...
Run com.container.microservices.currencyconversionservice.CurrencyConversionServiceApplicationMySql as a Java Application.
...
```
Rangas-MacBook-Air:aws-projects mibrahimdocker$ mysqlsh
MySQL Shell 8.0.15
...
- mvn package
- docker run --publish 8000:8000 --network MY_BRIDGE --name currency-exchange-microservice mibrahimdocker/aws-currency-exchange-service-mysql:0.0.1-SNAPSHOT
