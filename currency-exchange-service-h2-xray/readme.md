...
Run com.container.microservices.currencyconversionservice.CurrencyConversionServiceApplicationH2 as a Java Application.
...
- mvn package
- docker run --publish 8000:8000 --network MY_BRIDGE --name currency-exchange-microservice mibrahimdocker/aws-currency-exchange-service-h2-xray:0.0.1-SNAPSHOT
