...
#### Basic
```
docker container run --publish 8000:8000 mibrahimdocker/aws-currency-exchange-service-h2:0.0.1-SNAPSHOT
```
#### Custom Network
```
docker run --publish 8000:8000 --network currency-network --name=currency-exchange-service mibrahimdocker/aws-currency-exchange-service-h2:0.0.1-SNAPSHOT
```
